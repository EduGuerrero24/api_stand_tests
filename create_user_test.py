...
#Prueba 3. Usuario introduce menos de 2 caracteres para el firstName
def test_create_user_1_letter_in_first_name_get_error_response():
    negative_assert_symbol("A")

#Purueba 5. Usuario introduce su nombre con un espacio
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("A Aaa ")

#Prueba 6. Usuario ingresa un caracter especial
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("$$%&(/&")

#Prueba 7. Usiario ingresa números
def test_create_user_has_number_in_first_name_get_error_response():
    negative_assert_symbol(234)

#Preparación para las pruebas 8 y 9
...
#Prueba 8. La solicitud no contiene el parametro firstName
...
#Prueba 9. Usuario deja el campo fisrtName vacio
